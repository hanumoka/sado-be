...
- **[PROGRESS.md](./PROGRESS.md)** ⭐ - 전체 프로젝트 진행 상황 대시보드 (Phase별, Week별 체크리스트)
- **[CHANGELOG.md](./CHANGELOG.md)** - 날짜별 작업 이력 기록
- **[progress/](./progress/)** - 주차별 상세 진행 기록 (트러블슈팅, 학습 노트, 인사이트)

**활용 방법**:
- 매주 시작 시: `PROGRESS.md`에서 현재 주차 목표 확인
- 작업 중: `progress/week-XX.md`에 학습 내용, 트러블슈팅 기록
- 작업 완료 시: `CHANGELOG.md`에 변경 사항 기록
- 주말 회고: 진행률 업데이트, 다음 주 계획 작성
